...
### 3. Docker Compose & PostgreSQL (Production Stack)
```bash
# Start PostgreSQL and App services with unified static asset serving
docker compose up -d --build

# Run all automated unit & docker-compose integration tests (28 tests)
